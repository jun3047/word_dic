    ...
    <div className={`z-10 bg-white rounded-md top-46r right-0r py-15r absolute w-full flex flex-col shadow-md ${on || 'hidden'}`}>
      {
        relatedKeywords.map((text, i) => (
          <div key={i} onClick={()=>search(text)} className={`${i === 0 ? 'text-[#444444] bg-[#E9E9E9]': 'bg-white text-[#ABABAB]'} px-52r relative flex items-center w-[100%] h-30r caption-1 hover:text-[#444444] hover:bg-[#E9E9E9]`}>
