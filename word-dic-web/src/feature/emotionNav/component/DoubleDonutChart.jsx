...
const DoubleDonutChart = ({ setWord, emojiName, activeWord }) => {
    ...
    const data = DoubleDonutData(activeWord, isDarkMode);
...
const SecondHoverColor = (isDarkMode) => {
...
const SecondData = (activeWord, isDarkMode) => {
...
const DoubleDonutData = (activeWord, isDarkMode) => (
    {
        datasets: [
