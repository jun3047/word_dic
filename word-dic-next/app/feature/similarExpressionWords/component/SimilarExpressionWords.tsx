...
import { WORO_BOX_SIZE, FILTER_LIST } from '@/app/data/constant';
import useWordPagination from '@/app/feature/similarExpressionWords/hook/useWordPagination';
import useSortedFiltered유사표현List from '@/app/feature/similarExpressionWords/hook/useSortedFiltered유사표현List';
...
const 유사표현단어 = ({
    ...
    const [alignType, setAlignType] = useState<AlignType>('친숙성');
